  ...
  return (
    <section id="experience" className="relative py-24 sm:py-28">
      <div className="section-pad mx-auto max-w-5xl">
        <SectionHeading eyebrow="Experience" title="Internships & Experience" subtitle="Where I've put learning into practice." />
              ...
              >
                ...
                <div className="ml-12 sm:ml-0 sm:w-1/2 sm:px-8">
                  <div className="gradient-border rounded-2xl glass p-5">
                    <Placeholder label={exp.image} aspect="aspect-video" />
                  </div>
                </div>
