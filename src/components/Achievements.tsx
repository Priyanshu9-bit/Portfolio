          ...
          <div className="relative grid items-center gap-8 lg:grid-cols-2">
            <div>
              <div className="inline-flex items-center gap-2 rounded-full bg-amber-400/10 px-4 py-1.5 text-xs font-semibold text-amber-300 ring-1 ring-amber-400/20">
                <BadgeCheck className="h-3.5 w-3.5" /> Winner Badge
              </div>
              ...
              <div className="mt-5 flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-medium text-amber-300">GDG Hackathon 2025</p>
                </div>
              </div>

              <p className="mt-5 text-base leading-relaxed text-slate-300">{achievement.description}</p>

              <div className="mt-6 inline-flex items-center gap-2 rounded-full glass px-4 py-2 text-sm font-medium text-slate-200">
                <Award className="h-4 w-4 text-accent-pink" /> Competitive Innovation & Teamwork
              </div>
            </div>

            <div>
              <Placeholder label={achievement.image} aspect="aspect-[4/3]" className="shadow-2xl shadow-black/40" />
            </div>
          </div>
        </motion.div>
      </div>
